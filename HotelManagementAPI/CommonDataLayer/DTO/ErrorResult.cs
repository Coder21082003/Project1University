...
namespace CommonDataLayer.DTO
{
    public class ErrorResult
    {
        ...
        /// </summary>
        public ErrorCodeEnum ErrorCode { get; set; } = ErrorCodeEnum.Exception;
        ...
        public ErrorResult(ErrorCodeEnum errorCode, string? userMsg, object? devMsg, string? moreInfo, string? traceId)
        {
            ErrorCode = errorCode;
            UserMsg = userMsg;
            DevMsg = devMsg;
